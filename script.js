...
let exampleNode = {image : "bedroom.jpg", text : "The bedroom is more well-lit than the rest of the house. The dim yellow light reveals a room in perfect condition, a stark contrast to the decrepit nature of the building surrounding it.", choices : ["Go back to the foyer", "Return to the stairs", "Exit through the front"]};
...
let storyNodes = [exampleNode, foyerNode, entranceNode, stairsNode];
